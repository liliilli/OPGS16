...
public:
	...
	inline const glm::vec3 GetFinalPosition() const { return m_local_final_position; }

	inline void SetFinalPosition(const glm::vec3& final_position) {
		m_local_final_position = final_position;
	}

	inline void UpdateFinalPosition(const glm::vec3& parent_position) {
		m_local_final_position = m_local_position + parent_position;
	}

	inline const float GetRotationAngle() const { return m_rotation_angle; }
	...
	inline const glm::vec3 GetRotationFactor() const { return m_rotation_factor; }
	...
	inline const float GetScaleValue() const { return m_scale_value; }
	...
	inline const glm::vec3 GetScaleFactor() const { return m_scale_factor; }
