...
int main() {
    ...
    texture::Texture2D tex_quad         { "29_textures/bricks2.jpg", GL_RGB };
    texture::Texture2D tex_quad_normal  { "29_textures/bricks2_normal.jpg", GL_RGB };
    texture::Texture2D tex_quad_height  { "29_textures/bricks2_disp.jpg", GL_RGB };

    texture::Texture2D tex_toybox         { "29_textures/toybox.png", GL_RGB };
    texture::Texture2D tex_toybox_normal  { "29_textures/toybox_normal.png", GL_RGB };
    texture::Texture2D tex_toybox_height  { "29_textures/toybox_disp.png", GL_RGB };
    ...
    // Shaders
    helper::Shader shad_normal  { "29_shaders/quad.vert", "29_shaders/steep_quad.frag" };
    shad_normal.Use(); { // Setting
        ...
        shad_normal.SetInt("textureHeight", 3);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        common_model = glm::scale(common_model, glm::vec3(3.0f));
        
        {
            glActiveTexture(GL_TEXTURE0);
            glBindTexture(GL_TEXTURE_2D, tex_toybox.GetId());
            glActiveTexture(GL_TEXTURE2);
            glBindTexture(GL_TEXTURE_2D, tex_toybox_normal.GetId());
            glActiveTexture(GL_TEXTURE3);
            glBindTexture(GL_TEXTURE_2D, tex_toybox_height.GetId());
            ...
            glActiveTexture(GL_TEXTURE3);
            glBindTexture(GL_TEXTURE_2D, tex_quad_height.GetId());
